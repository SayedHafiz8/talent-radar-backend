...
import { create, deleting, getAll, getSpecific, setPlayerToBody, update, getPlayerStatistics } from "../controllers/scoutingReportController.js";
import { protect, allowedTo } from "../controllers/authController.js";
import { checkPlayerOwnership, checkReportOwnership } from "../middlewares/ownership.js";
import { createValidate, deleteValidate, getSpecificValidate, updateValidate, statisticsValidate } from "../utils/validation/scoutingValidation.js";
...
scoutingRouter
    ...
    .post(protect, allowedTo("coach"), checkPlayerOwnership, createValidate, setPlayerToBody, create);


scoutingRouter
    .route("/statistics")
    .get(protect, allowedTo("coach", "admin"), checkPlayerOwnership, statisticsValidate, getPlayerStatistics);
